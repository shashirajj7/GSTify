...
import { resetGuestCredits } from '../utils/credits';
        ...
        <div className="bg-gray-50 text-gray-800 font-sans antialiased overflow-hidden h-screen flex">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white relative overflow-y-auto">
                <div className="w-full max-w-md my-auto">
                    {/* Mobile Header / Logo */}
                    <Link to="/" className="flex lg:hidden items-center gap-2 cursor-pointer mb-10 w-fit">
                        <span className="material-symbols-outlined text-primary text-3xl">auto_awesome</span>
                    ...
                    <div className="space-y-4 mb-8">
                        <button
                            type="button"
                            onClick={() => alert('Google Authentication is coming soon! Please use email login for the demo.')}
                            className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors font-medium text-gray-700"
                        >
                    ...
                    <form className="space-y-5" onSubmit={handleLogin}>
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <Link to="/contact" className="text-sm font-medium text-primary hover:text-blue-700 transition-colors">Forgot password?</Link>
                            </div>
